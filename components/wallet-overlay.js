function createWalletOverlay() {
    const menuScrollContainer = document.getElementById("wallet-overlay");
    ...
    menuDiv.innerHTML = `
				...
				<div class="wallet-card">
					...
					<div class="change-btn-1">
						<a href="javascript:void(0);" class="btn btn-sm" data-bs-toggle="modal"
				...
				<div class="order-history">
					<div class="card price-list-1 mb-0">
						...
						<div class="card-footer text-center py-2">
							<a href="coin-details.html" class="btn-link text-primary">Show more <i
					...
					<div class="card price-list style-2 border-top border-style">
						...
						<div class="card-body p-3 py-0">
							<select
								class="form-control custom-image-select-2 style-1 image-select mt-3 mt-sm-0 pink-light style-1">
								<option data-thumbnail="images/svg/dash-pink.svg"
									data-content="<img src='images/svg/dash.svg'/> Dash Coin">Dash Coin</option>
								<option data-thumbnail="images/svg/btc.svg"
									data-content="<img src='images/svg/btc.svg'/> Ripple">Ripple</option>
								<option data-thumbnail="images/svg/eth.svg"
						...
						<div class="card-footer text-center py-2">
							<a href="coin-details.html" class="btn-link text-pink">Show more <i
									class="fa fa-caret-right ms-2"></i></a>
						</div>
					</div>
				</div>
