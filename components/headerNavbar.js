function createHeaderNavbar(pageTitle) {
    const createHeaderNavbar = document.getElementById("header-navbar");

    if (!createHeaderNavbar) {
        console.error("Error: #menu-scroll container not found.");
        return;
    }
    const headerNavbarDiv = document.createElement("div");

    headerNavbarDiv.innerHTML = `
										...
										<div class="header-info2 d-flex align-items-center">
											<div class="d-flex align-items-center sidebar-info">
												<div>
													...
													<span class="d-block text-end userEmail">...</span>
												</div>
											</div>
			...
			<div class="page-titles">
				<div class="sub-dz-head">
					<div class="d-flex align-items-center dz-head-title">
						<h2 class="text-white m-0 page-title">${ pageTitle }</h2>
						<p class="ms-2 text-warning">Welcome Back <span class="userName">...</span></p>
					</div>
    ...
    createHeaderNavbar.appendChild(headerNavbarDiv);
}

export { createHeaderNavbar };